...
def fetch_orders(frame, col_widths):
    try:
        ...
        for row_idx, order in enumerate(orders, start=1):
            ...
            # View Button
            view_btn_icon = Image.open("C:/Users/Dale Chavez/Downloads/PointOfSales_Oct26/PointOfSales/imgs/icons/view_icon.png")
            ...
            # Print Button
            print_btn_icon = Image.open("C:/Users/Dale Chavez/Downloads/PointOfSales_Oct26/PointOfSales/imgs/icons/print_icon.png")
